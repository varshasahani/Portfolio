...
async function getRating(){
    const ccurl =  'https://competitive-coding-api.herokuapp.com/api/codechef/varsha_sahani';
    const cfurl =  'https://competitive-coding-api.herokuapp.com/api/leetcode/varsha_sahani';
